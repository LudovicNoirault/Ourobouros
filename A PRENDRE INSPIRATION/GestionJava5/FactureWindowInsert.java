...
public class FactureWindowInsert extends JFrame {
	...
	private static ButtonGroup reglement_facture = new ButtonGroup();
	...
	public FactureWindowInsert() {
		...
		JLabel lblGestionDesFactures = new JLabel("Ajout d'une facture");
		...
		JLabel lblQuantFac = new JLabel("QuantitÃ© d'articles : ");
		...
		JLabel lblDelFac = new JLabel("DÃ©lais de paiement :");
		...
		JLabel lblRglFac = new JLabel("RÃ¨glement de la facture :");
		panel_ligne9.add(lblRglFac);
		
		JRadioButton reglement_factureT = new JRadioButton("Réglé");
		reglement_factureT.setSelected(true);
